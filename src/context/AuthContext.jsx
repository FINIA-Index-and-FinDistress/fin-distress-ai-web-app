...
// Context with explicit default value to prevent undefined errors
...
// AuthProvider component with comprehensive error handling
export const AuthProvider = ({ children }) => {
    ...
    // Better inactivity checking with proper error messages
    const checkInactivity = useCallback(() => {
        ...
        if (lastActivity && Date.now() - lastActivity > INACTIVITY_TIMEOUT) {
            ...
            // Add notification for inactivity timeout
    ...
    // Logout with session expired handling
    ...
    const initializeAuth = useCallback(async () => {
        try {
            ...
            if (storedExpiry && storedExpiry < now) {
                ...
                // Add notification for session expiry
                if (typeof window !== 'undefined' && window.dispatchEvent) {
                    window.dispatchEvent(new CustomEvent('auth-notification', {
                        detail: {
                            type: 'warning',
...
// useAuth hook with comprehensive fallback
