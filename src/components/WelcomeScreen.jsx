...
// import { Brain, TrendingUp, Shield, Zap, Users, Award, ExternalLink, Mail, Phone, MapPin, Sparkles, BookOpen, Database } from 'lucide-react';
...
//         { value: '3,241+', label: 'Companies Analyzed' },
...
//             <div className="mb-20">
//                 <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 rounded-3xl p-10 md:p-16 text-white relative overflow-hidden">
//                     {/* Background Pattern */}
...
//                         <div className="text-center mb-16">
//                             <div className="inline-flex items-center gap-3 bg-white/20 text-white px-6 py-3 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
...
//                         {/* Enhanced Research Partners */}
//                         <div className="grid md:grid-cols-3 gap-8 mb-16">
//                             {researchPartners.map((partner, index) => (
//                                 <div key={index} className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 hover:bg-white/15 transition-all duration-300 group">
//                                     <div className="text-center mb-6">
//                                         <div className="text-5xl mb-4 transform group-hover:scale-110 transition-transform">
//                                             {partner.logo}
//                                         </div>
//                                         <div className="inline-flex items-center gap-2 bg-yellow-400/20 text-yellow-300 px-3 py-1 rounded-full text-xs font-bold mb-4">
//                                             <Award className="w-3 h-3" />
//                                             {partner.highlight}
//                                         </div>
//                                         <h3 className="text-xl font-bold mb-1">{partner.shortName}</h3>
//                                         <p className="text-white/70 text-sm font-medium mb-4">{partner.location}</p>
//                                     </div>
...
//                             <div className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-400 to-orange-400 text-gray-900 px-8 py-4 rounded-2xl font-bold text-lg shadow-xl mb-8">
//                                 <Award className="w-6 h-6" />
//                                 Proudly Funded by AFRETEC NETWORK
//                             </div>

//                             <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-10 max-w-5xl mx-auto">
...
//                         {/* Enhanced Platform & Research Features */}
...
//                                     </div>
//                                     <h4 className="text-2xl font-bold">Platform Features</h4>
//                                 </div>
//                                 <ul className="space-y-3">
//                                     {platformFeatures.map((feature, index) => (
//                                         <li key={index} className="text-white/90 flex items-center justify-center gap-3">
...
//                                     </div>
//                                     <h4 className="text-2xl font-bold">Research Resources</h4>
//                                 </div>
//                                 <ul className="space-y-3">
