...
//  * Supports both login and registration with comprehensive validation
//  */
...
//         resetForm();
//     }, [setShowAuthModal, resetForm, loading, isSubmitting]);
...
//             setIsSubmitting(false);
//         }
//     }, [formData, authMode, validateForm, signIn, signUp, loading, isSubmitting, addNotification, handleClose]);
...
//                             <p className="text-sm text-red-800 font-medium">{validationErrors.submit}</p>
//                         </div>
//                     </div>
//                 )}
